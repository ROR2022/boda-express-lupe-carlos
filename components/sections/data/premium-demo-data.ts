...
export const premiumDemoData = {
  ...
  gallery: {
    ...
    images: [
      { 
        src: "/images/quinceElegante1.png ", 
        alt: "Sesión fotográfica 1", 
        caption: "Momentos Inolvidables",
        category: "preparacion"
      },
      { 
        src: "/images/quinceElegante2.png", 
        alt: "Sesión fotográfica 2", 
        caption: "Momentos Inolvidables",
        category: "vestido"
      },
      { 
        src: "/images/quinceElegante3.png", 
        alt: "Sesión fotográfica 3", 
        caption: "Momentos Inolvidables",
        category: "alegria"
      },
      { 
        src: "/images/quinceElegante4.png", 
        alt: "Sesión fotográfica 4", 
        caption: "Momentos Inolvidables",
        category: "celebracion"
      },
      {
        src: "/images/quinceElegante5.png",
        alt: "Sesión fotográfica 5",
        caption: "Momentos Inolvidables",
        category: "celebracion"
      },
      {
        src: "/images/quinceElegante6.png",
        alt: "Sesión fotográfica 6",
        caption: "Momentos Inolvidables",
        category: "celebracion"
      },
      {
        src: "/images/quinceElegante7.png",
        alt: "Sesión fotográfica 7",
        caption: "Momentos Inolvidables",
        category: "celebracion"
      },
      {
        src: "/images/quinceElegante8.png",
